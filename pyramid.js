...
export class Pyramid {
    constructor(position, size) {
        ...
        this.Verticies = [
            ...
            new Vertex(new Vector3(this.position.x - size, this.position.y + size, this.position.z - size)),
            new Vertex(new Vector3(this.position.x + size, this.position.y + size, this.position.z - size)),
            new Vertex(new Vector3(this.position.x, this.position.y - size, this.position.z))
        ];
        ...
        this.Lines = [
            ...
            new Line(this.Verticies[1], this.Verticies[4]),
            new Line(this.Verticies[2], this.Verticies[4]),
